...
*/
    ...
    Route::middleware(['auth', 'role:professor'])->prefix('professor')->name('professor.')->group(function () {
        ...
        Route::get('/courses/{courseOffering}/grades/manage', [ProfessorGradeController::class, 'manageGrades'])->name('grades.manage');
        Route::post('/courses/{courseOffering}/grades/store', [ProfessorGradeController::class, 'storeOrUpdate'])->name('grades.storeOrUpdate');
        Route::get('/professor/courses', [ProfessorGradeController::class, 'professorCourses'])->name('professor.courses');
        Route::get('/professor/grades/{courseOffering}', [ProfessorGradeController::class, 'manageGrades'])->name('grades.manage');
        Route::post('/professor/grades/{courseOffering}/store', [ProfessorGradeController::class, 'storeOrUpdateGrades'])->name('grades.storeOrUpdate');
        ...
        Route::get('/course-offering/{course_offering}/grades', [ProfessorGradeController::class, 'index'])
