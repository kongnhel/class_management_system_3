        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 lg:p-8 mb-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900">{{ __('available_courses') }}</h2>
                        <p class="mt-1 text-sm text-gray-500">{{ __('browse_available_courses') }}</p>
                    </div>
                </div>
            </div>
            ...
            @if ($availableCourses->isEmpty())
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-12 text-center">
                    ...
                    <p class="text-gray-500 font-bold text-lg">{{ __('no_courses_available') }}</p>
                    <p class="text-gray-400 text-sm mt-2">{{ __('please_check_later_or_contact_the_administration') }}</p>
                </div>
            @else
