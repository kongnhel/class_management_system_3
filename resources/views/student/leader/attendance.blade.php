            ...
            <div class="mb-6 md:mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 class="text-xl md:text-2xl font-extrabold text-slate-800 tracking-tight flex items-center gap-3">
                        <div class="p-1.5 md:p-2 bg-emerald-600 rounded-lg text-white">
                ...
                <a href="{{ route('student.leader.report', $courseOffering->id) }}" 
                   class="inline-flex items-center justify-center px-5 py-2.5 bg-white border border-slate-200 text-emerald-600 rounded-xl md:rounded-2xl font-bold text-sm hover:bg-emerald-50 transition-all shadow-sm group">
                ...
                <div class="bg-white rounded-3xl p-4 md:p-6 mb-6 border border-slate-200 shadow-sm flex flex-col md:flex-row items-end md:items-center justify-between gap-4 md:gap-6">
                    <div class="w-full md:w-72 group">
                        ...
                        <input type="date" name="attendance_date" value="{{ $today }}" 
                               class="w-full rounded-xl md:rounded-2xl border-slate-200 bg-slate-50/50 py-2.5 md:py-3 px-4 md:px-5 focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/5 transition-all font-bold text-slate-700 text-sm md:text-base cursor-pointer">
                    </div>
                    
                    <button type="submit" class="w-full md:w-auto px-8 py-3.5 md:py-4 bg-emerald-600 text-white rounded-xl md:rounded-2xl font-bold shadow-lg shadow-emerald-100 hover:bg-emerald-700 transition-all active:scale-95 flex items-center justify-center gap-2 text-sm md:text-base">
