...
<div class="container">
    <div class="toolbar">
        <h2>បញ្ជីឈ្មោះនិស្សិត - {{ $courseOffering->course->title_km ?? $courseOffering->course->title_en ?? '' }}</h2>
        <div>
    ...
    <div class="doc-header">
        ...
        <div class="text header-kh">
            ...
            <p class="line3">ឆ្នាំសិក្សា {{ $academicYear }}</p>
        ...
        <tbody>
            @foreach($students as $index => $student)
                @php
                    ...
                    $dob = $student->studentProfile->date_of_birth ?? $student->profile?->date_of_birth ?? null;
                @endphp
                <tr>
                    ...
                    <td class="col-dob" style="font-size:10px;">@if($dob){{ \Carbon\Carbon::parse($dob)->format('d/m/Y') }}@endif</td>
