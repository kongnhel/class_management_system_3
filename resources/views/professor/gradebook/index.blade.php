<div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
    <table class="w-full text-left border-collapse">
        <thead class="bg-slate-50 border-b border-slate-200">
            <tr>
                <th class="px-6 py-4 text-sm font-semibold text-slate-700">{{ __('rank') }}</th>
                <th class="px-6 py-4 text-sm font-semibold text-slate-700">{{ __('student_id') }}</th>
                <th class="px-6 py-4 text-sm font-semibold text-slate-700">{{ __('student_name') }}</th>
                <th class="px-6 py-4 text-sm font-semibold text-slate-700 text-center">{{ __('total_score_100') }}</th>
                <th class="px-6 py-4 text-sm font-semibold text-slate-700 text-center">{{ __('grade') }}</th>
            </tr>
        </thead>
