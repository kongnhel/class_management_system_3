                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-7">
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="absolute right-5 sm:right-6 top-1/2 -translate-y-1/2 text-[10px] font-black text-slate-400 uppercase">{{ __('score') }}</div>
                                    </div>
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    ...
                                    @if($gradingCategories->isEmpty())
                                        <p class="text-xs text-slate-400 mt-2 italic">{{ __('no_grading_categories_create_one') }}</p>
                                    @endif
