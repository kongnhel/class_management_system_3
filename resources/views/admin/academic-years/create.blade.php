    ...
    <div class="min-h-screen bg-gray-100 font-sans text-gray-900">
        <div class="bg-slate-900 text-white pb-32 pt-12 shadow-md">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-extrabold tracking-tight text-white">បង្កើតឆ្នាំសិក្សាថ្មី</h2>
                <p class="text-slate-400 mt-2 max-w-2xl text-sm leading-relaxed">បំពេញព័ត៌មានសម្រាប់ឆ្នាំសិក្សាថ្មី</p>
            </div>
        </div>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 pb-12 relative z-10">
            ...
            <form action="{{ route('admin.academic-years.store') }}" method="POST" class="bg-white rounded-xl shadow-xl border border-gray-100 p-6">
                @csrf
                <div class="space-y-6">
                    <div>
