    ...
    <div class="bg-gray-50 min-h-screen font-sans">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500 mt-2 ml-14">{{ __('fill_in_the_information_for_the_new_academic_year') }}</p>
            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea name="description" rows="3"
                                    ...
                                    placeholder="{{ __('description_of_the_academic_year') }}">{{ old('description') }}</textarea>
                            </div>
                        </div>
