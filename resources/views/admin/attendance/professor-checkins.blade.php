        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    <div data-admin-export-btn class="contents">
                        @php
                            $hasAllFilters = request('semester') && request('academic_year') && request('day_type');
                        @endphp
                        <a href="{{ $hasAllFilters ? route('admin.attendance.professorCheckinsExport', request()->query()) : '#' }}"
                           data-export-active
