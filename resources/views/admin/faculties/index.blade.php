                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="inline-flex rounded-xl bg-white border border-gray-200 p-1 shadow-sm">
                            ...
                            <button @click="viewMode = 'table'"
                                    :class="viewMode === 'table' ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-400 hover:text-gray-600'"
                        ...
                        {{-- Add Button --}}
                        <a href="{{ route('admin.create-faculty') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-xl shadow-sm hover:bg-blue-700 transition-colors">
