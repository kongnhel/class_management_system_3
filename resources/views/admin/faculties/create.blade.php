        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4 mb-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">{{ __('create_new_faculty') }}</h1>
                        <p class="text-sm text-gray-500 mt-0.5">{{ __('fill_in_the_information_below_to_add_a_new_faculty') }}</p>
                    </div>
                </div>
            </div>
