        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 lg:p-8">
                ...
                <div class="flex items-center gap-4 mb-8 pb-6 border-b border-gray-100">
                    ...
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900">{{ __('edit_department') }}</h2>
                        <p class="mt-1 text-sm text-gray-500">{{ __('edit_information_for') }} <span class="font-semibold text-gray-700">{{ $department->name_km }}</span></p>
                    </div>
                </div>
