        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">{{ __('edit_room') }}</h1>
                        <p class="text-gray-500 text-sm mt-0.5">{{ __('fill_in_the_information_below_to_edit_the_room') }}</p>
                    </div>
                </div>
            </div>
                                ...
                                <div class="relative w-36 h-36 flex-shrink-0">
                                    ...
                                    <template x-if="!imagePreview">
                                        @if($room->wifi_qr_code)
                                            <img src="{{ str_starts_with($room->wifi_qr_code, 'http') ? $room->wifi_qr_code : asset('storage/' . $room->wifi_qr_code) }}" class="w-full h-full object-contain rounded-xl border border-gray-200 bg-white shadow-sm">
                                        @else
                                            <div class="w-full h-full flex flex-col items-center justify-center bg-gray-100 rounded-xl text-gray-400">
                                                ...
                                                <span class="text-xs">{{ __('no_image') }}</span>
                                            </div>
                                        @endif
                                    </template>
                                </div>
                                <div class="flex-1">
                                    <p class="text-sm text-gray-600 mb-3">{{ __('select_a_new_image_to_replace_the_old_one') }}</p>
