        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">{{ __('បន្ទប់') }} {{ $room->room_number }}</h1>
                        <p class="text-gray-400 text-sm mt-0.5">{{ __('ព័ត៌មានលម្អិតនៃបន្ទប់') }}</p>
                    </div>
                </div>
                            ...
                            <div class="aspect-square bg-gray-50 rounded-xl flex items-center justify-center border border-gray-100">
                                ...
                                @else
                                    <div class="flex flex-col items-center justify-center text-gray-300">
                                        ...
                                        <span class="text-sm">{{ __('មិនមានរូបភាព') }}</span>
                                    </div>
                                @endif
                            </div>
                            <p class="text-xs text-gray-400 text-center mt-3">{{ __('ស្កេនដើម្បីភ្ជាប់ WiFi') }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                        <div class="p-6 sm:p-8">
                            ...
                            <div class="divide-y divide-gray-100">
                                ...
                                <div class="flex items-center justify-between py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-sm text-gray-500">{{ __('សមត្ថភាព') }}</span>
                                    </div>
                                    <span class="text-sm font-semibold text-gray-900">{{ $room->capacity }} {{ __('នាក់') }}</span>
                                </div>
                                ...
                                <div class="flex items-center justify-between py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-sm text-gray-500">{{ __('ទីតាំង') }}</span>
                                    </div>
                                    <span class="text-sm font-semibold text-gray-900">{{ $room->location_of_room ?? __('មិនបានកំណត់') }}</span>
                                </div>
                                ...
                                <div class="flex items-center justify-between py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-sm text-gray-500">{{ __('ឈ្មោះ WiFi') }}</span>
                                    </div>
                                ...
                                <div class="flex items-center justify-between py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-sm text-gray-500">{{ __('ពាក្យសម្ងាត់ WiFi') }}</span>
                                    </div>
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100 flex items-center gap-2 text-xs text-gray-400">
                                ...
                                {{ __('បង្កើតនៅ') }} {{ $room->created_at->format('d M Y, H:i') }}
                            </div>
                        </div>
                    </div>
                </div>
