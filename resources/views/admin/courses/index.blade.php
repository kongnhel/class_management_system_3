            ...
            <div x-data="{ viewMode: 'table' }"
                ...
                <div class="p-6 lg:p-8 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        {{-- Search Input --}}
                        <form method="GET" action="{{ route('admin.manage-courses') }}" id="courseSearchForm" data-admin-realtime-filter class="relative group">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="{{ __('ស្វែងរកមុខវិជ្ជា...') }}" autocomplete="off"
