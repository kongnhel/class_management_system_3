    ...
    <div class="min-h-screen bg-gray-100 font-sans text-gray-900">
        <div class="bg-slate-900 text-white pb-32 pt-12 shadow-md">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-extrabold tracking-tight text-white">ការគ្រប់គ្រងពិន្ទុ</h2>
                <p class="text-slate-400 mt-2 max-w-2xl text-sm leading-relaxed">មើលពិន្ទុរបស់សិស្សទាំងអស់ក្នុងមុខវិជ្ជាផ្សេងៗ</p>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 pb-12 relative z-10">
            <div class="bg-white rounded-xl shadow-xl border border-gray-100 p-5 mb-8">
                <form action="{{ route('admin.grades.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-12 gap-5 items-end">
                    ...
                    <div class="md:col-span-3 flex justify-end gap-2">
                        <a href="{{ route('admin.grades.index') }}" class="px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg transition-colors font-bold text-sm">
                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center gap-2">
                                    <a href="{{ route('admin.grades.show', $offering->id) }}" class="p-2 text-blue-600 hover:bg-blue-50 rounded-xl transition-colors" title="មើលពិន្ទុ">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.grades.export', $offering->id) }}" class="p-2 text-emerald-600 hover:bg-emerald-50 rounded-xl transition-colors" title="នាំចេញ">
