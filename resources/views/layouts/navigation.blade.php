    ...
    <div class="flex flex-col h-full">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar px-4 py-4 space-y-1">
            ...
            <a href="{{ route('dashboard') }}" 
               class="flex items-center gap-3 px-4 py-3 text-base font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-green-600 text-white shadow-lg shadow-green-600/20' : 'text-gray-300 hover:bg-slate-700/60 hover:text-white' }}">
            ...
            @if($user->role === 'admin')
                ...
                {{-- Academic Section --}}
                <div x-data="{ open: {{ in_array(request()->route()->getName() ?? '', ['admin.academic-years.*', 'admin.manage-courses', 'admin.manage-course-offerings', 'admin.manage-programs', 'admin.manage-faculties', 'admin.manage-departments', 'admin.rooms.*']) ? 'true' : 'false' }} }" class="mt-3">
                    <button @click="open = !open" class="flex items-center justify-between w-full px-4 py-2.5 text-xs font-bold uppercase tracking-widest text-slate-500 hover:text-slate-400 transition-colors">
                        <span>{{ __('nav_management') }}</span>
                    ...
                    <div x-show="open" x-collapse x-cloak class="space-y-0.5">
                        <a href="{{ route('admin.academic-years.index') }}" 
                           class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('admin.academic-years.*') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                            <span>{{ __('ឆ្នាំសិក្សា') }}</span>
                        </a>
                        <a href="{{ route('admin.manage-faculties') }}" 
                           class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('admin.manage-faculties') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 8h6M9 12h6M9 16h6"/></svg>
                            <span>{{ __('nav_faculty_management') }}</span>
                        </a>
                        <a href="{{ route('admin.manage-departments') }}" 
                           class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('admin.manage-departments') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        ...
                        <a href="{{ route('admin.manage-programs') }}" 
                           class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('admin.manage-programs') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        ...
                        <a href="{{ route('admin.manage-courses') }}" 
                           class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('admin.manage-courses') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        ...
                        <a href="{{ route('admin.manage-course-offerings') }}" 
                           class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('admin.manage-course-offerings') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                            <span>{{ __('nav_course_offering_management') }}</span>
                        </a>
                        <a href="{{ route('admin.rooms.index') }}" 
                           class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('admin.rooms.*') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                ...
                <div x-data="{ open: {{ in_array(request()->route()->getName() ?? '', ['admin.manage-users', 'admin.create-user', 'admin.show-user']) ? 'true' : 'false' }} }" class="mt-2">
                    <button @click="open = !open" class="flex items-center justify-between w-full px-3 py-2 text-[11px] font-bold uppercase tracking-widest text-slate-500 hover:text-slate-400 transition-colors">
                    ...
                    <div x-show="open" x-collapse x-cloak class="space-y-0.5">
                        ...
                        <a href="{{ route('admin.manage-users', ['tab' => 'admins']) }}" 
                           class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->query('tab') === 'admins' ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        ...
                        <a href="{{ route('admin.manage-users', ['tab' => 'professors']) }}" 
                           class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->query('tab') === 'professors' ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9.5a2.5 2.5 0 00-2.5-2.5H14"/></svg>
                            <span>{{ __('nav_professors') }}</span>
                        </a>
                        <a href="{{ route('admin.manage-users', ['tab' => 'students']) }}" 
                           class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->query('tab') === 'students' ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        ...
                        <a href="{{ route('admin.create-user') }}" 
                           class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('admin.create-user') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                ...
                <div class="mt-2 space-y-0.5">
                    <div class="px-4 py-2.5 text-xs font-bold uppercase tracking-widest text-slate-500">វិនិច្ឆ័យ</div>
                    <a href="{{ route('admin.grades.index') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('admin.grades.*') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                        <span>{{ __('ពិន្ទុសិស្ស') }}</span>
                    </a>
                    <a href="{{ route('admin.attendance.index') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('admin.attendance.*') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                ...
                {{-- Announcements --}}
                <div class="mt-2 space-y-0.5">
                    <div class="px-4 py-2.5 text-xs font-bold uppercase tracking-widest text-slate-500">ផ្សេងៗ</div>
                    <a href="{{ route('admin.announcements.index') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('admin.announcements.*') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
            ...
            @if($user->role === 'professor')
                <div class="mt-3 space-y-0.5">
                    <div class="px-4 py-2.5 text-xs font-bold uppercase tracking-widest text-slate-500">{{ __('nav_for_professors') }}</div>
                    <a href="{{ route('professor.profile.show') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('professor.profile.*') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.93 1.327 6.379 3.804M15 9a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        <span>{{ __('nav_profile') }}</span>
                    </a>
                    <a href="{{ route('professor.my-course-offerings') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('professor.my-course-offerings') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.206 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.794 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.794 5 16.5 5c1.706 0 3.332.477 4.5 1.253v13C19.832 18.477 18.206 18 16.5 18c-1.706 0-3.332.477-4.5 1.253"/></svg>
                        <span>{{ __('nav_my_teaching') }}</span>
                    </a>
                    <a href="{{ route('professor.notifications.index') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('professor.notifications.*') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        <div class="relative">
                    ...
                    <a href="{{ route('professor.my-schedule') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('professor.my-schedule') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        <span>{{ __('nav_my_schedule') }}</span>
                    </a>
                    <a href="{{ route('professor.attendance.history') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('professor.attendance.history') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
            ...
            @if($user->role === 'student')
                <div class="mt-3 space-y-0.5">
                    <div class="px-4 py-2.5 text-xs font-bold uppercase tracking-widest text-slate-500">{{ __('nav_for_students') }}</div>
                    ...
                    <a href="{{ route('student.profile.show') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('student.profile.*') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.93 1.327 6.379 3.804M15 9a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        <span>{{ __('nav_profile') }}</span>
                    </a>
                    <a href="{{ route('student.my-enrolled-courses') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('student.my-enrolled-courses') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                    ...
                    <a href="{{ route('student.rooms.index') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('student.rooms.*') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9.75V20a1 1 0 001 1h16a1 1 0 001-1V9.75M12 3l8.485 6.364a1 1 0 01-1.414 1.414L12 5.828 4.929 11.778a1 1 0 01-1.414-1.414L12 3z"/></svg>
                        <span>{{ __('nav_rooms') }}</span>
                    </a>
                    <a href="{{ route('student.my-schedule') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('student.my-schedule') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        <span>{{ __('nav_my_schedule') }}</span>
                    </a>
                    <a href="{{ route('student.my-grades') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('student.my-grades') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        <span>{{ __('nav_my_grades') }}</span>
                    </a>
                    <a href="{{ route('student.my-attendance') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 text-base font-medium rounded-xl transition-all {{ request()->routeIs('student.my-attendance') ? 'bg-green-600 text-white' : 'text-gray-400 hover:bg-slate-700/60 hover:text-white' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
